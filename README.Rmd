...
flag above is required for `browseVignettes()` to find them. The
CRAN release ships prebuilt vignettes and needs no extra flag.
...
- Paper: *Beyond Pearson: Visualising Asymmetric Non-linear
  Associations with Generalised Additive Models* (Moldovan, in
  preparation; target venue *R Journal*).
